...
\usepackage{graphicx}
\usepackage{pdflscape, tabularx, ragged2e, float, array, tabto}
...
\section{Přehledy}
    ...
    \subsection{Vitaminy}
        \begin{table}[H]
            \begin{tabular}{| m{7em} | m{5em} | m{5em} | m{8em}<{\RaggedRight} | m{15em}<{\RaggedRight} | m{15em}<{\RaggedRight} | m{10em}<{\RaggedRight} |}
                \hline
                \multicolumn{7}{| c |}{Přehled vitaminů}\\
                \hline
                Název & Skupina & Doporučená denní dávka & Zdroj & Význam & Projevy nedostatku & Poznámka \\
                \hline
                ...
                \hline
                $B_3$ (kys. pantotenová) & deriv. kys. máselné & 7-10mg & játra, kvasnice, hrách, maso, mléko, vejce &&& \\
                \hline
                $B_6$ (pyridoxin) & & 2mg & kvasnice, obilné klíčky, mléko, luštěniny &&& \\
                \hline
                $B_12$ (kobalamin)& & 0.001mg & játra, maso, činností bakterií vznik ve střevech &&& \\
                %\endfirsthead
                \hline
                Kys. nikotinová & heterocykl &&&&& \\
                \hline
                Kys. listová & heterocykl &&&&& \\
                \hline
